      ...
      <article className=" w-full md:w-3/5 ">
        <header className=" pl-4 ">
          ...
          <div className=" lg:text-md my-2 -mt-[0px] w-full max-w-full text-sm text-default-600 md:w-1/2 ">
            Leader en France dans le secteur médical et paramédical
          </div>
        </header>

        <div className=" mt-6 flex flex-col items-start justify-start ">
          <Roles
            role="Expert Logiciel / Référent technique"
            description="En tant qu'expert logiciel et référent technique en France pour Maiia Gestion, j'ai l'opportunité de travailler de près avec les équipes R&D et Produit. Je dois contribuer à la formation continue des techniciens Junior et Senior, répondre à leurs demandes lorsqu'ils sont bloqués et les accompagner dans leur montée en compétence. Je dois également participer à la création de documentations techniques et à la rédaction de scénarios de tests. Enfin, je gère une partie des tickets de bug (JIRA) en fournissant une analyse détaillée lorsque aucune solution n'est possible afin d'optimiser le workflow de l'équipe R&D."
            location="Rodez, FR"
            startDate="Août 2022"
