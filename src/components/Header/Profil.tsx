    ...
    <header className=" mx-auto flex h-full w-screen flex-col items-start justify-center gap-8 bg-[#f3f4f5] p-10 md:flex-row ">
      ...
      <section className=" flex w-full flex-col gap-4 md:w-2/5">
        ...
        <div>
          ...
          <div className="flex items-center justify-start gap-2">
            <MailIcon />
            <a href="mailto:contact@sofiane-rahmani.com?subject=Contact professionnel : [NOM DE VOTRE ENTREPRISE]" className="text-[#0073aa] hover:underline">
              contact@sofiane-rahmani.com
            </a>
          </div>
